...
const translations = {
  ar: {
    ...
    hero_text: "نعمل من أجل مستقبل طاقة مستدام ومزدهر لليمن",
     // من نحن
     about_title: "من نحن",
     about_text1: "تعد الوحدة التنفيذية للمشاريع الممولة دوليًا (PIU) وحدة متخصصة تعمل تحت مظلة وزارة الكهرباء والطاقة، وتهدف إلى إدارة وتنسيق جميع المشاريع الممولة دوليًا في قطاع الطاقة عبر مختلف محافظات اليمن. تأسست الوحدة لتعزيز البنية التحتية للطاقة الوطنية، رفع مستوى القدرات المؤسسية، وضمان تنفيذ المشاريع وفق أفضل المعايير الدولية.<br><br>تلعب الوحدة دورًا محوريًا في التخطيط الاستراتيجي، الإشراف الفني، وإدارة العمليات التشغيلية للمشاريع، مع التركيز على توسيع الوصول إلى الطاقة، تحديث البنية التحتية الحيوية، ودعم حلول الطاقة المستدامة. كما تعمل الوحدة على تعزيز الشفافية، ضمان الحوكمة الرشيدة، ومتابعة الالتزام بالمعايير العالمية في جميع مراحل تنفيذ المشاريع.",
     about_text2: "وتستند أعمال الوحدة إلى فرق فنية متخصصة وإطار عمل متكامل يربط بين السياسات الوطنية وأفضل الممارسات الدولية، مع التركيز على الابتكار في الحلول التقنية، بناء القدرات المحلية، وتعزيز التعاون بين الجهات الحكومية، الشركاء الدوليين، والقطاع الخاص.<br><br>تتمثل رؤية الوحدة في تقديم حلول طاقة موثوقة ومستدامة وبتكاليف مناسبة لجميع شرائح المجتمع، والمساهمة في تحقيق نمو اقتصادي مستدام، وتحسين جودة الحياة في المناطق الحضرية والريفية على حد سواء. كما تسعى الوحدة إلى دعم التحول نحو الطاقة المتجددة، وتعزيز مرونة أنظمة الطاقة، وضمان استفادة المجتمع ككل من التطورات في قطاع الطاقة.",
  ...
  obj_title: "الأهداف",
    ...
    co2_text: "تلتزم الوحدة التنفيذية للمشاريع الممولة دوليًا بدعم تحول اليمن نحو مستقبل طاقي منخفض الانبعاثات ومرن أمام التغير المناخي. من خلال دمج حلول الطاقة المتجددة، بما في ذلك تقنيات الطاقة الشمسية وطاقة الرياح، وتشجيع ممارسات كفاءة الطاقة، تسهم الوحدة في تقليل الاعتماد على الوقود الأحفوري وخفض الانبعاثات الغازية الضارة. تقوم الوحدة بتنفيذ استراتيجيات ومشاريع مبتكرة تتماشى مع أهداف الاستدامة الوطنية، لضمان أن تصبح التقنيات النظيفة محورًا رئيسيًا في قطاع الطاقة في اليمن. ومن خلال التخطيط الاستباقي، الحلول التقنية المبتكرة، وتعزيز القدرات المحلية، تسعى الوحدة إلى موازنة الطلب على الطاقة مع حماية البيئة، وتمهيد الطريق نحو مستقبل مستدام وواعٍ بيئيًا.",

    facility_title: "مرافقنا التي تم تقييمها بعناية",
    facility_text1: "تتمتع الوحدة التنفيذية للمشاريع الممولة دوليًا بأعلى معايير الكفاءة والجودة، حيث خضعت عملياتها وأنظمتها لتقييم شامل بواسطه البنك الدولي و UNOPS يغطي إدارة الموارد المالية، إجراءات الشراء والمناقصات، وأطر متابعة المشاريع، لضمان توافق الممارسات مع المعايير الدولية وتعزيز إدارة المشاريع الممولة دوليًا.",
  ...
  en: {
    ...
    facility_text1: "The Project Implementation Unit operates with efficiently managed facilities, where all processes have undergone a comprehensive evaluation by World Bank and UNOPS covering financial management, procurement procedures, and project monitoring frameworks. This ensures that our practices align with international standards and strengthens the management of donor-funded projects.",

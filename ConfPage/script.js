...
const translations = {
  ar: {
    ...
    about_title: "من نحن",
    about_text:
    " يعد هذا المؤتمر رفيع المستوى استجابة عاجلة للحاجة الملحة في اليمن إلى إصلاح هيكلي في قطاع الطاقة، وانتقال وطني نحو مصادر طاقة نظيفة وفعالة من حيث التكلفة. ويهدف إلى إقامة حوار استراتيجي بين المؤسسات الحكومية والجهات المانحة الدولية وقطاع الأعمال ومنظمات المجتمع المدني.<br><br> كما يسعى المؤتمر إلى ترسيخ نهج متكامل لمعالجة الاحتياجات الخاصة بقطاع الطاقة في اليمن، والاستفادة من الخبرات العالمية وفرص التمويل المناخي، مما يمهد الطريق نحو التعافي الأخضر على المدى الطويل، وبناء بنية تحتية مرنة وقادرة على الصمود. ",
...
function translateScheduleCells(lang) {
  ...
  const translationsMap = lang === "ar" ? [
    ["15 Nov", "15 نوفمبر"], ["16 Nov", "16 نوفمبر"], ["17 Nov", "17 نوفمبر"],
    ...
    ["15 نوفمبر", "15 Nov"], ["16 نوفمبر", "16 Nov"], ["17 نوفمبر", "17 Nov"],
